...
import { uploadAdminCategoryImageAction } from "../../../../lib/actions/admin/upload-action";
...
export default function CategoryFormModal({
  ...
  error: string;
  saving: boolean;
  onChange: (form: AdminCategoryFormPayload) => void;
  onClose: () => void;
        ...
        <div className="flex items-start justify-between gap-4 border-b border-slate-100 px-6 py-5">
          <div>
            ...
            <h2 className="mt-1 text-xl font-semibold text-slate-950">
              {mode === "edit" ? "Update Category Details" : "Add New Category"}
            </h2>
          </div>
          <button
            type="button"
